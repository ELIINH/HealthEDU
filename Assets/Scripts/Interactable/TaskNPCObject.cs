...
public class TaskNPCObject : InteractableObject
{
    ...
    public DialogueEntry[] contentInTaskExecuting; // 修改为 DialogueEntry 数组
    public DialogueEntry[] contentInTaskCompleted; // 修改为 DialogueEntry 数组
    public DialogueEntry[] contentInTaskEnd;       // 修改为 DialogueEntry 数组
